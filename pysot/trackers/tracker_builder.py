...
from pysot.trackers.mobilesiam_tracker import MobileSiamTracker
from pysot.trackers.updmobilesiam_tracker import UPDMobileSiamTracker


TRACKS = {
          'MobileSiam': MobileSiamTracker,
          'UPDMobileSiam': UPDMobileSiamTracker,
