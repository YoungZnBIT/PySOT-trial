...
__C.BASE = 'anchor'
__C.TRIAL_CFG = 'experiments/siamban/anchor-based-rpn.yaml'
__C.SELF_EPOCH = 10
__C.VALIDATE = False
__C.VALIDATE_CFG = 'experiments/siamban/rpn-val.yaml'
__C.AMP = False
__C.MODE = 'normal'
...
# __C.DATASET.NAMES = ('VID', 'COCO', 'DET')
